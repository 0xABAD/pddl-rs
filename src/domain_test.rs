...
#[test]
fn can_parse_constants() -> Result<(), ParseError> {
    let d = Domain::parse(
        "(define (domain foo)
           (:requirements :strips :typing)
           (:types block square sphere)
...
#[test]
fn allow_parsing_of_empty_constants() -> Result<(), ParseError> {
    let d = Domain::parse(
        "(define (domain foo)
           (:requirements :strips :typing)
           (:types block square sphere)
...
#[test]
fn allow_parsing_constants_without_types() -> Result<(), ParseError> {
    let d = Domain::parse(
        "(define (domain foo)
           (:requirements :strips)
           (:constants bar baz))",
...
#[test]
fn constants_collates_either_types() -> Result<(), ParseError> {
    let d = Domain::parse(
        "(define (domain foo)
           (:requirements :strips :typing)
           (:types block square sphere)
